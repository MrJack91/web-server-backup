...
BACKUP_DIR="/Users/michaelhadorn/backups/"  # The directory in which you want backups placed
DUMP_MYSQL=true
TAR_SITES=true
...
MYSQL_DATABASE="typo3" # which database to backup, if this is empty all databases will be back uped

SITES_DIR="/Users/michaelhadorn/projects/newTypo3/"
